...
public class AppStart extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(view);
		// 判断是否是第一次启动
		SharedPreferences sPreferences = getSharedPreferences("AppInfo", Context.MODE_PRIVATE);
		boolean isFirstStart = sPreferences.getBoolean("isFirstStart", false);
        if (!isFirstStart) {
        	redirectTo();
        	return;
		}
