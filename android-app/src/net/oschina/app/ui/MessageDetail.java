 ...
 * @created 2012-3-21
 */
public class MessageDetail extends CustomActivity {
    ...
    private void initView()
    {
    	...
    	mFootPubcomment = (ImageButton)findViewById(R.id.message_detail_foot_pubcomment);
    	mFootPubcomment.setOnClickListener(messagePubClickListener);
    	mFootEditebox = (TextView)findViewById(R.id.message_detail_footbar_editebox);
    	...
    	getSupportActionBar().setTitle(getString(R.string.message_detail_head_title,curFriendName));
