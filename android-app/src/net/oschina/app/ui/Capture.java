...
public final class Capture extends BaseActionBarActivity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle icicle) {
		...
		getSupportActionBar().setTitle(R.string.capture_head_title);
	...
	private void signin(Barcode barcode) {
		...
		signin.show(getSupportFragmentManager(), SigninDialog.TAG);
	}
