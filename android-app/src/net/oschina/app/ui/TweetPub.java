 ...
 * @created 2014-7-2
 */
public class TweetPub extends BaseActionBarActivity{
    ...
    {   
    	getSupportActionBar().setTitle(R.string.tweet_pub_head_title);
    	//软键盘管理类
	...
	private void publish(){
		...
		String content = mContent.getText().toString();
		if(StringUtils.isEmpty(content)){
			UIHelper.ToastMessage(TweetPub.this, "请输入动弹内容");
			return;
		}
		// 调用动弹发布方法
