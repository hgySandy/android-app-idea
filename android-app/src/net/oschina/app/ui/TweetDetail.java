 ...
 * @created 2012-6-19
 */
public class TweetDetail extends CustomActivity {
	...
	private void initView() {
		getSupportActionBar().setTitle(R.string.tweet_detail_head_title);
		...
		mFootPubcomment = (ImageButton) findViewById(R.id.tweet_detail_foot_pubcomment);
		...
		UIHelper.setZoomControlGone(content);
