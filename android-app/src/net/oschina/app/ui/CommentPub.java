 ...
 * @created 2014-6-21
 */
public class CommentPub extends BaseActionBarActivity{
    ...
    private void initView(){
    	getSupportActionBar().setTitle(R.string.comment_pub_head_title);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		mInflater.inflate(R.menu.commentpub_activity_menu, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.commentpub_activity_put:
			publish();
			return true;
	...
	private void publish(){
		...
		if(StringUtils.isEmpty(_content)){
			UIHelper.ToastMessage(CommentPub.this, "请输入评论内容");
			return;
		}
    	...
    	mProgress = ProgressDialog.show(CommentPub.this, null, "发表中···",true,true); 			
